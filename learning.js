//ВІДЕОКУРС ПО JAVASCRIPT: https://www.udemy.com/home/my-courses/learning/
...
//      >>>>>>ПРИМІТКА: FOREACH дуже класно використовувати для циклів з масивами. (ДИВИТИСЬ РОЗДІЛ "ЦИКЛИ")<<<<<
...
/* =========================================================================================================================================== */
/* =========================================================================================================================================== */
//УМОВНІ ІНСТРУКЦІЇ:  if; if...else; else...if; switch; тернарний оператор;
...
//Приклад 2: якщо у об'єкті person не існує властивості name, то на екрані з'явиться повідомлення
/* const person = {
    age: 15,
}
...
//Приклад 1: якщо змінна value має якесь значення (не false; не null; не пустий рядок; не undefined), то виконається дія після знаку ?. Якщо ж ні, то дія після знаку :
/* const value = 17
...
/* =========================================================================================================================================== */
/* =========================================================================================================================================== */
//ЦИКЛИ: for / for...in... / while / do...while / for...of...

//FOR:
//Синтаксис:
/* for (Початкова інструкція; Умова; Ітераційна дія) {
    //Блок коду, який виконується на кожній ітерації
} */

//Приклад: В результаті на екран будуть виведені значення від 0 до 4
/* for (let i = 0; i < 5; i++) {
    console.log(i)
} */

/* =========================================================================================================================================== */
//ПЕРЕБІР МАСИВІВ: для цього краще використовувати "Функції вищого порядку-forEach, map, reduce, і т.д.", а не цикл for
//Наприклад:
/* const myArray = ['first', 'second', 'third']

myArray.forEach((element, index) => {       //Параметр element-буде представляти собою кожен елемент масиву(тобто first,second,third). А параметр index буде представляти індекс кожного елемента(тобто 0,1,2)
    console.log(element, index)
})
 */

//Але якщо треба зробити за допомогою циклу for, то це можна зробити наступним чином:
/* const myArray = ['first', 'second', 'third']
...
/* =========================================================================================================================================== */
//WHILE: дозволяє виконувати блок коду, допоки умова правдива
//Синтаксис:
/* while (Умова) {
    //Блок коду, який буде виконано для кожної ітерації
} 
*/
//Приклад:
/* let i = 0
...
while (i < 5) {
    console.log(i)
    i++     //Змінна змінної, яка впливає на умову. Якщо цього не буде, то буде безкінечний цикл.
} */


/* =========================================================================================================================================== */
//DO...WHILE: виконається як мінімум 1 раз
//Синтаксис:
/* do {
    //Блок коду який виконується на кожній ітерації, перед перевіркою Умови.
} while (Умова)
 */
//Приклад: 
/* let i = 0
...
//Синтаксис:
/* for (key in Object) {
    //Дія з кожною властивістю об'єкту
...
for (const key in myObject) {       //key-це назва властивості об'єкта myObject. myObject-це об'єкт, властивості і значення якого ми будемо використовувати у ціклі.
    console.log(key, myObject[key])     //тут ми вимодимо на екран кожну властивість об'єкта. а також значення кожної властивості об'єкта. Або ж ми можемо вивести тільки щось одне.
}
 */


/* =========================================================================================================================================== */
//FOREACH для об'єктів: це зручно використовувати як цикл, для того, щоб отримати ключі або ж значення об'єкту

//Приклад: отримуємо ключі (name, age, city) об'єкту 
/* const myObj = {
    name: 'Hed',
    age: 30,
    city: 'Lviv',
...
//Приклад: отримуємо ЗНАЧЕННЯ (Hed, 30, Lviv) ключів об'єкту
/* const myObj = {
    name: 'Hed',
    age: 30,
    city: 'Lviv',
...
//Або ж ми можемо отримати і ключі і значення ключі об'єкту за допомогоу forEach
/* const myObj = {
    name: 'Hed',
    age: 30,
    city: 'Lviv',
...
Object.keys(myObj).forEach(key => {     //Object.keys повертає масив властивостей об'єкта myObj
...
/* =========================================================================================================================================== */
//FOR IN для масивів: за допомогою такого коду можна перебрати елементи масиву. (АЛЕ ТАК РОБИТИ НЕ РЕКОМЕНДУЄТЬСЯ!!!)
...
/* =========================================================================================================================================== */
//FOR OF: кльово використовувати для перебору. (Але не можна використовувати для об'єктів!!!)
//Синтаксис:
/* for (Element of Iterable) {     //Iterable - це будь яке значення або змінна, із допомогою якого можна ітеруватись(тобто перебирати). 
    //Дії з певним елементом
}
 */

//Приклад 1: перебір кожної букви
/* const myStr = 'Hed'
...
//Приклад 2: як перебирати елементи масиву (АЛЕ ТАК РОБИТИ НЕ РЕКОМЕНДУЄТЬСЯ!!!)
/* const myArray = [true, 10, 'abc', null]
...
//ТОМУ КРАЩЕ ВИКОРИСТОВУВАТИ FOREACH ДЛЯ МАСИВІВ !!!
/* const myArray = [true, 10, 'abc', null]
...
/* =========================================================================================================================================== */
/* =========================================================================================================================================== */
//МОДУЛІ: дозволяють структурувати код. дозволяє уникати дублювання блоків коду.
...
//Наприклад у нас є два модулі (module.One.js та moduleTwo.js). Із першого модуля ми будемо експортувати об'єкт, і імпортувати його у другий модуль
//moduleOne.js має:
/* const myName = () => {
    console.log('HED')
}
...
//moduleTwo.js має:
import printMyName from './moduleOne.js'        //Назви змінних myName та printMyName можуть не співпадати, тільки якщо відбувається дефолтний експорт(тобто вказано export default)

printMyName()       //HED
 */
//Приклади експорту та імпорту дивитись у папці modules

/* =========================================================================================================================================== */
//ПРАВИЛА РОБОТИ З МОДУЛЯМИ:
/*
- Модулі мають бути одноцільовими. Мається на увазі, можливість розділити великий шматок коду на багато різних блоків коду(модулі). І кожен такий модуль ми маємо могти використовувати багаторазово у різних файлах.
- Розміщуй усі export інструкції внизу файлу. Це робить код більш читабельним.
- Усі інструкції import розміщуй зверху файлу.
- По можливості використовуй export default. Тобто експортуй тільки щось одне із модуля.
*/
...
/* =========================================================================================================================================== */
/* =========================================================================================================================================== */
// !!!КЛАСИ ТА ПРОТОТИПИ!!! Дуже важлива тема!

/* Класи дозволяють:
- Створювати прототипи для об'єктів;
- На основі прототипів можна створити Екземпляри;
- Екземпляри у свою чергу можуть мати свої особисті властивості та методи, які прив'язані до конкретного екземпляра;
- Також екземпляри можуть наслідувати властивості та методи Прототипів;
*/
...
/* 
const firstComment = new Comment('First comment')       //new - це унарний оператор за допомогою якого можна створити новий екземпляр класу. Тут якраз викликається функція constructor у яку передається значення ('First comment')

console.log(firstComment)       //Comment { text: 'First comment', votesQty: 0 }
 */

/* =========================================================================================================================================== */
//Як перевірити до якого класу належить об'єкт: із допомогою instanceof
/* 
const resInst = firstComment instanceof Comment     //true
console.log(resInst)
const resInst2 = firstComment instanceof Object      //true
console.log(resInst2)
 */

/* =========================================================================================================================================== */
//Виклик методів класу: відбувається за допомогою "." та вказується "метод()" ( приклад: firstComment.upvote() ). Методи можна викликати багаторазово, як то зроблено у прикладі нижче.
//Приклад:
/* 
firstComment.upvote()
console.log(firstComment.votesQty)      //1
firstComment.upvote()       //ще раз викликаємо upvote, і тому значення збільшиться ще на 1
console.log(firstComment.votesQty)      //2
 */


/* =========================================================================================================================================== */
//Перевірка принадлежності властивостей екземпляра об'єкта: hasOwnProperty
/* 
...
/* =========================================================================================================================================== */
//Створення декількох екземплярів одного класу:
/* const firstComment = new Comment('First comment')
const secondComment = new Comment('Second comment')
const thirdComment = new Comment('Third comment')
 */
//Далі ми робимо Виклик методу upvote() для кожного нового екземпляра класу:
/* 
firstComment.upvote()
...
//Або ж можна то реалізувати у циклі:
/* for (let i = 0; i < 1; i++) {
    firstComment.upvote()
}
...
console.log(thirdComment.votesQty)      //7
 */
...
/* =========================================================================================================================================== */
//Розширення інших класів: дуже цікава штука. (Примітка: У данному прикладі наступний ланцюг прототипів: myArray -> NumbersArray -> Array -> Object)
/*
У наступному прикладі ми створюємо новий клас NumbersArray, який за основу бере клас Array і усі його методи(такі як: forEach, map, і т.д.). 
А також додає новий метод sum (або будь який, який ми створимо), який повертає суму елементів масиву за допомогою метода reduce(), який пішов від Array.
Але основне це те, що ми створюємо новий масив myArray на основі класу NumbersArray, який використовує батьківський конструктор Array(який повертає масив).
*/

/* 
class NumbersArray extends Array {      //Створюємо клас NumbersArray на основі класу Array. У такому випадку NumbersArray унаслідує усі методи класу Array.. Клас Array існує в JS по замовчюванню. Він створює масив.
    sum() {
        
            //Далі із допомогою метода reduce() (цей метод доступний від конструктора Array) можна просумувати елементи масива. 
            //У данному прикладі reduce має два параметра el(елемент) та acc(акумулятор). Акумулятор-це окрема змінна, яка може змінюватися у процесі ітерації по масиву. Тобто ця коллбек функція буде викликана стільки разів, скільки елементів у масиві.
            //Так як, наша задача тут-це просумувати значення масиву, тому 0-це початкове значення акумулятора. І на кожній ітерації ми до акумулятора додаємо значення кожного елемента, і присвоюємо йому вже нове значення. Тобто += це додати та присвоїти нове значення.
            //І у наступній ітерації, цей акумулятор вже буде мати нове значення.
            //У результаті, пройшовши по усім елементам масиву ми просумуємо їх.
            
        //return this.reduce((el, acc) => acc += el, 0)
        
        //Або ж це ще можна зробити наступним чином. Де element-це кожен елемент масиву починаючи з нульового. А amount це значення наступного елемента масиву. 
        //У результаті ми до значення кожного попереднього елемента додаємо значення наступного (тобто 2+5=7), присвоюємо element результат цієї суми і сумуємо зі значенням наступного елемента масиву і присвоюємо результат (7+10=17) і фініш, оскільки більше елементів у масиві немає. 
        //Також треба зауважити, що ми не вказали ", 0"..у такому випадку на початку ітерацій element отримає значення першого елемента масиву.
        return this.reduce((element, amount) => element + amount)      
    }
}

const myArray = new NumbersArray(2, 5, 10)      //Створюємо новий об'єкт(масив) myArray(зі значеннями 2,5,10) на основі класу NumbersArray.

console.log(myArray)        //Тут ми просто показуємо масив myArray.
console.log(myArray.sum())      //Тут ми викликаємо метод sum, який сумує усі елементи масиву myArray і виводить результат на екран
console.log(myArray.map(el => el*2))        //А тут ми викликаємо метод map(який був унаслідуванний від класу Array). MAP поверне новий масив у якому усі елементи масиву myArray перемножаться на 2
 */


/* =========================================================================================================================================== */
//Рядки та числа ведуть себе як об'єкти: 
/*
У прикладі нижче ми створили змінну myName, значення якої є рядком(String).
Але вона має властивості так самі як має об'єкт. Тобто це доводить, що змінні у JS є об'єктами.
І у прикладі нижче ми викликаємо об'єкт "length" який повертає нам довжину рядка.
*/
...
if (myName.length <= 3) {
    console.log('Please type more characters')
} else console.log('Number of characters = ', myName.length)
 */
...
/* =========================================================================================================================================== */
/* =========================================================================================================================================== */
//ПРОМІСИ: Дозволяють обробляти відкладені у часі події. Тобто очікують відповідіть від сервера.

//Проміс - це клас, який вже існує у JS. Його не потрібно знову створювати.

//Часто використовуються з базами даних.

//Також проміс може повернути помилку, якщо неможливо надати результат
//Проміс має три стани: 1)Очікування(як тільки проміс був створений); 2)Виконаний(якщо був повернутий результат); 3)Відхилений(якщо повернулась помилка);

//Синтаксис:
/* const myPromise = new Promise ((resolve, reject) => {       //resolve та reject -це два обов'язкових параметра. А також це функції.
    
    //Виконання асинхронних дій

    //Всередині цієї функції треба в результаті викликати
        //одну із функцій resolve або reject
});
 */

//Отримання результату проміса:
/* myPromise
    .then(value => {
        //Дія у випадку успішного виконанням Проміса
        //Значення value - це значення, яке було передане у виклику функції resolve всередині Проміса
    })
    .catch(error => {
        //Дія у випадку відхилення Проміса
        //Значення error - це значення, яке було передане у виклику функції reject всередині проміса
    })
 */

//FETCH: приклад отримання данних від сервера. !!!ВИКОНУВАТИ У БРАУЗЕРІ!!!
/* 
fetch('https://jsonplaceholder.typicode.com/todos/1')
      .then(response => response.json())
      .then(json => console.log(json))
      .catch(error => console.log(error))
//Результат: {userId: 1, id: 1, title: 'delectus aut autem', completed: false}
 */
