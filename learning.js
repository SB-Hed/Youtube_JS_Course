...
//IF ELSE IF:
/* if (Умова 1) {
    //Блок кода, виконується ОДИН РАЗ, якщо Умова 1 правдива
} else if (Умова 2) {
    //Блок кода, виконується ОДИН РАЗ, якщо Умова 2 правдива
} else {
    //Блок кода, виконується ОДИН РАЗ, якщо попередні умови хибні (Не Правдиві)
}
 */
