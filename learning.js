...
/*
- Модулі мають бути одноцілевими. Мається на увазі, можливість розділити великий шматок коду на багато різних блоків коду(модулі). І кожен такий модуль ми маємо могти використовувати багаторазово у різних файлах.
...
class Comment {
    constructor(text) {
        this.text = text        //змінна this вказує на Екземпляр к ласу
        this.votesQty = 0
    }
